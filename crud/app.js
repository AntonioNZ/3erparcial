const cargarPosts=async()=>{
    ...
    data.map(item=>{
        ...
        <td>${item.title}</td>
        <td>${item.body}</td>
        <td><button class="btn btn-outline-warning" data-bs-toggle="modal" data-bs-target="#editModal" onclick="cargarPost(${item.id})">EDITAR
        </button></button></td>
        <td><button class="btn btn-outline-danger" data-bs-toggle="modal" data-bs-target="#deleteModal" onclick="eliminarPost(${item.id})">ELIMINAR
        </button></button></td>
        </tr>`;
    })
}
